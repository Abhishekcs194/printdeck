...
internal val LightColors = PrintDeckColors(
    background = White,
...
internal val DarkColors = PrintDeckColors(
    background = Dark950,
    foreground = Dark50,
    muted = Dark800,
...
internal val LocalPrintDeckColors = staticCompositionLocalOf { LightColors }
